...
//
//        Mockito.when(assignmentService.createAssignment(any(AssignmentDTO.class))).thenReturn(responseAssignment);
//
...
//        Mockito.when(assignmentService.updateAssignment(anyInt(), any(AssignmentDTO.class))).thenReturn(null);
//
//        // Create a mock assignment DTO
//        AssignmentDTO assignmentDTO = new AssignmentDTO();
//
//        // Create the controller
//        AssignmentController controller = new AssignmentController(assignmentService);
//
//        // Call the updateAssignment method with a non-existent assignment ID
//        ResponseEntity<AssignmentDTO> responseEntity = controller.updateAssignment(123456789, assignmentDTO);
//
